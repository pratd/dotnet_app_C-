                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:Button class="btn btn-primary" ID="LinkButton4" Text="Go" runat="server" OnClick="Button4_Click"/>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-8">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList1" runat="server">
                              ...
                              <asp:ListItem Text="Marathi" Value="Arabic" />
                              <asp:ListItem Text="French" Value="French" />
                              <asp:ListItem Text="German" Value="German" />
                               <asp:ListItem Text="German" Value="Spanish" />
                              <asp:ListItem Text="Urdu" Value="Chinese" />
                           </asp:DropDownList>
                        </div>
                                                ...
                                                <div class="col-lg-10 ">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            ...
                                                            Publisher-
                                                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="Medium" Text='<%# Eval("publisher_name") %>'></asp:Label>
                                                            &nbsp;| Publish-Date-
